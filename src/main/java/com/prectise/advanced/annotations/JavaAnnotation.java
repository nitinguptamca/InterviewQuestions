package com.prectise.advanced.annotations;
...
public @interface JavaAnnotation {
    ...
    // annotation then that will be compiled time error
    int hoursPerDay();
...
// 6.
// Using a mandatory and optional field. Order does not matter here.
