...
public class JavaArray {
    ...
    public static void main(String[] args) {
        ...
        System.out.println( Arrays.compare(new int [] {10}, null) ); // 1
        ...
        System.out.println( Arrays.compare(null, a1) ); // 0

        int[] a3 = {1};
        System.out.println( Arrays.compare(null, a3) ); // -1
        System.out.println( Arrays.compare(a3, a3) ); // 0
